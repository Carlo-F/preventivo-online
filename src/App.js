        ...
        <div className="App">
          <header className="App-header">
            <div className="Section title">
                ...
                <p>Calcola il preventivo per il tuo <strong>sito internet</strong> gratuitamente.<br></br>Seleziona le opzioni che ti interessano per un preventivo istantaneo.</p>
            </div>
            ...
            <div className="Section credits">
              <p>Strumento di preventivo online gratuito per siti internet sviluppato da <Button className="secondary" href="https://www.carlof.it" color="secondary">Carlo F. Web Solutions</Button></p>
            </div>
          </header>
        </div>
      );
